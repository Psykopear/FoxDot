...
"""
from .PlayString import PlayString, ParseError
from .Generators import PRand
from .PGroups import PGroupOr, PGroupPlus
...
def feed(string):
    """
    Used to recursively parse nested strings, returns a
    list object (not Pattern), and a boolean denoting
    if the list contains a nested list
    """
