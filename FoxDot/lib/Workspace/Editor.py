...
class workspace:
    ...
    def __init__(self, CodeClass):
        ...
        def check_versions():
            ...
            if pypi_version is not None and VersionNumber(pypi_version) > VersionNumber(
                this_version
            ):
        ...
        try:
            ...
            self.root.tk.call(
                "wm", "iconphoto", self.root._w, PhotoImage(file=FOXDOT_ICON_GIF)
            )
        ...
        self.text.bind(
            "<{}-l>".format(ctrl), lambda event: self.insert_char(u"\u03BB")
        )  # insert lambda
    ...
    def help(self, event=None):
        ...
        print(
            "{}+{}                : Toggle console window".format(ctrl, self.toggle_key)
        )
    ...
    def toggle_sc3_plugins(self, event=None):
        ...
        tkMessageBox.showwarning(
            ...
            message="Restart of FoxDot is required for the changes to take effect",
        )
        return "break"
